...
* @route '/livewire-e55da267/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-e55da267/upload-file',
...
* @route '/livewire-e55da267/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-e55da267/preview-file/{filename}',
