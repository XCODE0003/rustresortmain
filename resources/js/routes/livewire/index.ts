...
* @route '/livewire-a0032235/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-a0032235/upload-file',
...
* @route '/livewire-a0032235/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-a0032235/preview-file/{filename}',
