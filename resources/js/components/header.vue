          ...
          <div class="flex items-center gap-2 md:gap-4 lg:gap-6">
            ...
            <template v-if="user">
              ...
              >
                ...
                <span class="text-xs font-bold whitespace-nowrap text-Orange">{{ displayMoney(user.balance) }}</span>
              </Link>
              ...
              <div class="hidden items-center gap-2 md:flex">
                ...
                >
                  ...
                  <span class="text-sm font-bold whitespace-nowrap text-Orange">{{ displayMoney(user.balance) }}</span>
                </Link>
