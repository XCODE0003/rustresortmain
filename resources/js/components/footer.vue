    ...
    >
        ...
        <div class="flex items-center justify-center lg:justify-between w-full">
            ...
            <div class="flex items-center gap-2.5 max-lg:hidden">
                <a href="#" class="hover:fill-[#c4302b] fill-[#636363] ease-in-out duration-300">
                    <svg
                ...
                <a href="#" class="hover:fill-[#F3A45D] fill-[#636363] ease-in-out duration-300">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                ...
                <a href="#" class="hover:fill-[#4c75a3] fill-[#636363] ease-in-out duration-300">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
