...
/**
* @see \App\Http\Controllers\Backend\SettingsController::store
* @see app/Http/Controllers/Backend/SettingsController.php:200
* @route '/backend_uc7BgHFmw32FDIEp/settings'
*/
...
const SettingsController = { index, site, project_name, robots, sitemap, langs, analitics, about, download, login, login_steam, policy, forum, social, donat, services, smtp, recaptcha, sms, payments, streams, game_api, waxpeer_api, skinsback_api, falling_snow, bonuses, bonuses_monday, bonuses_thursday, store }
